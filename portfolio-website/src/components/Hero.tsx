  ...
  return (
    <>
      <section id="home" className={styles.section}>
        {/* Container */}
        <div className="w-[80%] md:w-[70%] mx-auto border-4 h-full mt-8 flex flex-col gap-12 lg:gap-24 justify-center items-center">
          {/* Info and Picture */}
          <div className=" w-full flex justify-end md:gap-20 h-3/4 lg:h-1/2 flex-col-reverse md:flex-row">
            ...
            <div className="flex w-full h-fit md:h-full flex-col items-center md:items-start justify-start md:justify-center">
              <h1 className="text-center md:text-left font-bold h-fit py-4 leading-tight text-5xl sm:text-[55px] tracking-tight w-full flex-shrink-0">
                The Front-end Engineer.
              </h1>
              <p className=" text-center lg:text-left  text-lg sm:text-lg tracking-relaxed mb-8 flex-shrink-0">
            ...
            {/* Picture */}
            <div className="border border-red-400 lg:h-full w-full h-[65%]">
              Picture
            </div>
          </div>
          {/* Tech Stack */}
          <div className=" h-fit gap-8 mb-32 lg:mb-8 flex md:flex-row flex-col items-center justify-center md:justify-start w-full">
